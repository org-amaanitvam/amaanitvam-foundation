...
const studentNavItems = [
  ...
  { name: 'Help & Support', path: '/student/help', icon: LifeBuoy },
];

export default function StudentSidebar({ onLogout, userProfile, open, onClose }) {
  ...
  return (
    <aside
      className={`w-64 bg-[#56051a] text-white flex flex-col min-h-screen shadow-xl border-r border-[#d8a15f]/20 shrink-0 fixed lg:static inset-y-0 left-0 z-50 transition-transform duration-300 lg:translate-x-0 ${
    ...
    >
      <div className="px-6 py-6 border-b border-[#d8a15f]/10 bg-black/20 flex items-center justify-between">
        ...
        >
          <div className="h-11 w-11 rounded-xl bg-gradient-to-tr from-[#8a164b] to-[#d8a15f] flex items-center justify-center shadow-lg">
      ...
      <nav className="flex-1 overflow-y-auto py-5 px-4 space-y-1.5 [&::-webkit-scrollbar]:hidden scrollbar-none">
